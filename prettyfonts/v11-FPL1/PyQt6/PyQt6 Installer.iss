...
OutputBaseFilename=BunnyPad-PyQt6-v11FPL1
SolidCompression=yes
WizardStyle=modern
LicenseFile="C:\BunnyPad\v11-FPL1\Qt6\License.txt"
InfoBeforeFile="C:\BunnyPad\v11-FPL1\Qt6\InfoBefore.txt"
Compression=lzma
DisableDirPage=auto
...
[Files]
; Main executable
Source: "C:\BunnyPad\v11-FPL1\Qt6\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion

; Assets folder
Source: "C:\BunnyPad\v11-FPL1\Qt6\assets\*"; DestDir: "{app}\assets"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\BunnyPad\v11-FPL1\Qt6\NOTICE.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\BunnyPad\v11-FPL1\Qt6\License.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\BunnyPad\v11-FPL1\Qt6\InfoBefore.txt"; DestDir: "{app}"; Flags: ignoreversion
