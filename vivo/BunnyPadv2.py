...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(QLabel("Bunny, you're awesome! I am inspired by you in a lot of ways."))
...
'''
Day {err_strmiss_time} of missing my best friend. Stay safe, please.
If you go away permanently, I'll lose myself.
C:\\Users\\BunnyPad\\Desktop\\> dir hope.exe
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        exit_action = QAction(QIcon(os.path.join('images', 'exit.png')), "Exit", self)
